   ...
   public void addElement(String element) {
     // System.out.println("Opening...");
      synchronized (synchedList) {
         ...
         System.out.println("Added New Element:'" + element + "' added to synchedList");

         synchedList.notifyAll();
         System.out.println("notified waiting threads");
         }catch(Exception e){
        	 System.out.println("exception occoured while calling notify");
        	 e.printStackTrace();
      ...
      Runnable runA = new Runnable() {
         ...
         public void run() {
            try {
               ...
               System.out.println("Exception thrown."+x.getMessage());
               x.printStackTrace();
            }
         }
      };
