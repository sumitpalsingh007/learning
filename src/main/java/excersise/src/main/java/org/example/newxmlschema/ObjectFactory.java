...
public class ObjectFactory {
    ...
    private final static QName _Dictionary_QNAME = new QName("http://www.example.org/NewXMLSchema", "Dictionary");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://www.example.org/NewXMLSchema", name = "Dictionary")
